...
def tf_d3_detection_model_configs():
    """Returns a default detection configs.
    ...
    # model name.
    h.name = 'tf_efficientdet_d3'

    h.backbone_name = 'tf_efficientnet_b3'
    h.backbone_args = {'drop_path_rate': 0.2}  # FIXME sort out kwargs vs config for backbone creation
    ...
    h.pad_type = 'same'  # original TF models require an equivalent of Tensorflow 'SAME' padding
    h.act_type = 'swish'
    h.box_class_repeats = 4
    h.fpn_cell_repeats = 6
    h.fpn_channels = 160
    h.separable_conv = True
    h.apply_bn_for_resampling = True
    h.conv_after_downsample = False
    ...
    h.url='https://github.com/rwightman/efficientdet-pytorch/releases/download/v0.1/tf_efficientdet_d3-b0ea2cbc.pth'

    return h


def tf_d4_detection_model_configs():
    """Returns a default detection configs."""
    h = OmegaConf.create()
    ...
    h.backbone_args = {'drop_path_rate': 0.2} #None  # FIXME sort out kwargs vs config for backbone creation

    # model specific, input preprocessing parameters
    h.image_size = 1024 #640
    ...
    h.pad_type = 'same'  # original TF models require an equivalent of Tensorflow 'SAME' padding
    h.act_type = 'swish'
    h.box_class_repeats = 4 #3
    h.fpn_cell_repeats = 7 #3
    h.fpn_channels = 224 #88
    h.separable_conv = True
    h.apply_bn_for_resampling = True
    h.conv_after_downsample = False
    h.conv_bn_relu_pattern = False
    ...
    h.url='https://github.com/rwightman/efficientdet-pytorch/releases/download/v0.1/tf_efficientdet_d4-5b370b7a.pth'

    return h


def tf_d5_detection_model_configs():
    """Returns a default detection configs.
    ...
    h.url='https://github.com/rwightman/efficientdet-pytorch/releases/download/v0.1/tf_efficientdet_d5-ef44aea8.pth'

    return h


def tf_d6_detection_model_configs():
    """Returns a default detection configs.
    ...
    # model name.
    h.name = 'tf_efficientdet_d6'

    h.backbone_name = 'tf_efficientnet_b6'
    h.backbone_args = {'drop_path_rate': 0.2}  # FIXME sort out kwargs vs config for backbone creation
    ...
    h.pad_type = 'same'  # original TF models require an equivalent of Tensorflow 'SAME' padding
    h.act_type = 'swish'
    h.box_class_repeats = 5
    h.fpn_cell_repeats = 8
    h.fpn_channels = 384
    h.separable_conv = True
    h.apply_bn_for_resampling = True
    h.conv_after_downsample = False
    ...
    h.url='https://github.com/rwightman/efficientdet-pytorch/releases/download/v0.1/tf_efficientdet_d6-51cb0132.pth'

    return h


def tf_d7_detection_model_configs():
    """Returns a default detection configs.
    ...
    h.url='https://github.com/rwightman/efficientdet-pytorch/releases/download/v0.1/tf_efficientdet_d7_53-6d1d7a95.pth'
