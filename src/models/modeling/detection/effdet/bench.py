...
from src.models.backbone.pytorch.timm_0_1_30.timm.utils import ModelEma

from .anchors import Anchors, AnchorLabeler, generate_detections, MAX_DETECTION_POINTS
from src.models.loss.detection.loss import DetectionLoss
...
def _post_process(config, cls_outputs, box_outputs):
    ...
    indices_all = cls_topk_indices_all // config.num_classes # changed / to // due to torch1.6.0 torch.true_divide(cls_topk_indices_all, config.num_classes)
