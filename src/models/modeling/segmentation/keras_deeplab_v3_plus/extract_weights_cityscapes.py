...
CKPT_URL_MOBILE = 'http://download.tensorflow.org/models/deeplabv3_mnv2_cityscapes_train_2018_02_05.tar.gz'
MODEL_DIR = 'models'
MODEL_SUBDIR = 'deeplabv3_cityscapes_train'
MODEL_SUBDIR_MOBILE = 'deeplabv3_mnv2_cityscapes_train'
...
extract_tensors_from_checkpoint_file(
    checkpoint_file, net_name='xception', output_folder='weights/xception_city')

checkpoint_file = os.path.join(
    MODEL_DIR, MODEL_SUBDIR_MOBILE, 'model.ckpt')
extract_tensors_from_checkpoint_file(
    checkpoint_file, net_name='mobilenetv2', output_folder='weights/mobilenetv2_city')
